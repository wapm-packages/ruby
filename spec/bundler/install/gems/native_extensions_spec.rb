...
RSpec.describe "installing a gem with native extensions" do
  ...
  it "installs correctly from git when multiple gems with extensions share one repository" do
    ...
    config "build.c_extension_one --with-c_extension_one=one"
    config "build.c_extension_two --with-c_extension_two=two"
  ...
  it "install with multiple build flags" do
    ...
    config "build.c_extension --with-c_extension=hello --with-c_extension_bundle-dir=hola"
